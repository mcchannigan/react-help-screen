...
One of the users listed in section one must be designated as the supervisor. Click the radio button next to the appropriate username to designate the supervisor.
